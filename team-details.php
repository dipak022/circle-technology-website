                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="breadcrumb-inner text-center">
                                <h1><?php echo $language['team']; ?></h1>
                                <ul class="breadcrumb-links">
                                    <li>
                                        <a href="index.php"><?php echo $language['home']; ?></a>
                                    </li>
                                    <li class="active">
                                    <?php echo $language['team']; ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-6 col-md-12">
                            <div class="about-inner">
                                <h4>
                                    <?php if ($type=='furkan_hossain'){
                                    echo $language['head_of_strategies'];

                                    }  elseif ($type=='fakrul_hasan'){
                                        echo $language['head_of_operations'];
                                    }
                                    elseif ($type=='md_miarul_islam'){
                                        echo $language['head_of_technology'];
                                    }
                                    elseif ($type=='md_masudur_rahman'){
                                        echo $language['head_of_product_quality'];
                                    }
                                    ?>
                                </h4>
                                    <?php if ($type=='furkan_hossain'){
                                            echo $language['head_of_strategies_details'];

                                        }  elseif ($type=='fakrul_hasan'){
                                            echo $language['head_of_operations_details'];
                                        }
                                        elseif ($type=='md_miarul_islam'){
                                            echo $language['head_of_technology_details'];
                                        }
                                        elseif ($type=='md_masudur_rahman'){
                                            echo $language['head_of_product_quality_details'];
                                        }
                                    ?>
                        ...
                        <div class="col-lg-5 col-xl-6 col-md-12">
                            <div class="about-img">
                                <img class="img-fluid" style="height: 550px;width:100%;" src=" <?php if ($type=='furkan_hossain'){
                                      echo 'img/furkan_hossain.jpg';

                                  }  elseif ($type=='fakrul_hasan'){
                                      echo 'img/fakrul_hasan.jpg';
                                  }
                                  elseif ($type=='md_miarul_islam'){
                                      echo 'img/md_miarul_islam.jpg';
                                  }
                                  elseif ($type=='md_masudur_rahman'){
                                      echo 'img/md_masudur_rahman.jpg';
                                  }
                                  ?>">
                            </div>
                        </div>
